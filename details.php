		...
		<div class = "content">
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-head" style = "background: #823E39" >
                  <div class="pull-left" style = "color: #ffffff">Reservation Details</div>
                    ...
                    <br>
                     ...
                     <form class="form-horizontal" role="form" action="details_save.php" method="post">
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">Venue</label>
                                  <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">Date of Event</label>
                                  <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">Time of Event</label>
                                  <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">Motif</label>
                                  <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">Occasion</label>
                                  <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">No. of Pax</label>
                                  <div class="col-lg-5">
                                    <input type="number" class="form-control" placeholder="No. of Pax" name="pax">
                                  </div>
                                </div> 
                                <div class="form-group">
                                  <label class="col-lg-2 control-label" style="font-size: 15px">Type</label>
                                  <div class="col-lg-2" style="font-size: 15px">
                                    <input type="radio" class="form-radio" name="type" value="buffet" style="font-size: 15px"> Buffet
                                  </div>
                                  <div class="col-lg-2" style="font-size: 15px">
                                    <input type="radio" class="form-radio" name="type" value="plated" style="font-size: 15px"> Plated 
                                  </div>
                                </div>  
                               <div class="form-group">
