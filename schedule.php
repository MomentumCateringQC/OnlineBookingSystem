...
<body>
	...
	<?php include 'menu-tab.php';?>
		...
		<div class = "content" >
				...
				<div class = "col-md-9 col-lg-9">
					<div class="widget wgreen">
		                ...
		                <div class="widget-head"style="background:#823E39">
		                  <div class="pull-left"style="color:#fff">Events</div>
			...
			<div class = "content">
			<div class = "col-g-12 col-md-12 col-sm-12 col-xs-12 color:#FFFFFF" style="background:#FFFFFF; height:215px; color:#FFFFFF bgcolor:#FFFFF">
						<div class = "widget-content" style="background:#FFFFFF; color:#FFFFFF; bgcolor:#FFFFF">
						</div>						
					</div>				
				</div>	
