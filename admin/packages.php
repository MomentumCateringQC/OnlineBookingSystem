...
<div class="content" style="margin-top:10px;background: #823E39">
    ...
    <div class="mainbar" style="background:#E9BF6F">
      ...
      <div class="page-head" style="background:#E9BF6F">
        ...
        <a href="#addModal" class="btn btn-info" style = "background: #823E39" data-toggle="modal">Add New Packages</a>
      </h2>
            ...
            <div class="col-md-12">
              ...
              <div class="widget" >
                <div class="widget-head" style = "background: #823E39">
                  <div class="pull-left" style = "color: #ffffff"> Packages Category
                  </div>
...
include('../includes/dbcon.php');
    ...
    $query=mysqli_query($con,"SELECT * FROM packagescategory INNER JOIN packages ON packagescategory.packagescategory_id=packages.packagescategory_id")or die(mysqli_error($con));
...
?>                      
                      <tr>
                        <td><img src="../packages/<?php echo $image;?>" width="100px" height="100px"></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style = "background: #823E39">
              ...
              <h4 class="modal-title" style = "color: #ffffff">Update Packages</h4>
            </div>
            <div class="modal-body" style="height:200px">
     
              <form class="form-horizontal" method="post" action="packages_update.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <select class="form-control" name="packagescategory_id" id="title">
                          <option value="<?php echo $packagescategory_id ?>"><?php echo $category ?></option>
                          <?php $query2=mysqli_query($con,"SELECT * from packagescategory")or die(mysqli_error($con)); ?>

                           <?php while ($row2=mysqli_fetch_array($query2)){ ?>
                            <option value="<?php echo $row2['packagescategory_id'] ?>"><?php echo $row2['category'] ?></option>
                          <?php } ?>
                          ?>
                        </select>
                      </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post" action="packages_delete.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="packages_save.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="title">Category </label>
                      <div class="col-lg-8"> 
                        <select type="file" class="form-control" name="packagescategory_id" id="title">
                          <option value="">Select</option>
                          <?php $query=mysqli_query($con,"SELECT * from packagescategory")or die(mysqli_error($con)); ?>

                           <?php while ($row=mysqli_fetch_array($query)){ ?>
                            <option value="<?php echo $row['packagescategory_id'] ?>"><?php echo $row['category'] ?></option>
                          <?php } ?>
                          ?>
                        </select>
                      </div>
