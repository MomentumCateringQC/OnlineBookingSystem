...
include('../includes/dbcon.php');
 ...
 { 
	 ...
	 mysqli_query($con,"delete from team_member WHERE team_id='$id' and member_id NOT IN (".implode(',',$members).")")or die(mysqli_error());

	 	$description = 'Staff Update Team Members';
	...
	foreach ($members as $value)
	{
		$query=mysqli_query($con,"select * from team_member where team_id='$id' and member_id='$value'")or die(mysqli_error($con));
      		...
      		{
				mysqli_query($con,"INSERT INTO team_member(team_id,member_id) VALUES('$team','$value')")or die(mysqli_error());  
			}	
	}	 	
