...
//     'number' => '09602055981',
//     'message' => 'I just sent my first message with Semaphore 43534534',
            ...
            <div class="col-md-12">
              ...
              <div class="widget" >
                <div class="widget-head" style = "background: #823E39">
                  <div class="pull-left" style = "color: #ffffff"> Approved Reservation
                  </div>
...
?>                      
                      <tr>
                        ...
                        <td>
                              <a href="#payment" class="btn btn-default payment" data-target="#payment" 
                              data-amount="<?php echo $balanceamount[0]; ?>"
                              data-payment_id="<?php echo $id;?>" data-toggle="modal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style = "background: #823E39">
              ...
              <h4 class="modal-title" style = "color: #ffffff">Update Reservation Details</h4>
            </div>
...
<div id="assign<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style = "background: #823E39">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" style = "color: #ffffff" >Assign Team</h4>
            </div>
            ...
            <div class="modal-body" style="height:150px">
              ...
              <form class="form-horizontal" method="post" action="payment_save.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control inputamount" onkeyup="finalamount()" name="amount" id="title" placeholder="Enter Amount">
                        <input type="hidden" class="form-control checkamount" id="title" placeholder="Enter Amount">
                      </div>
                  </div> 
                  ...
                  <div class="col-md-8">
                        <button type="submit" style = "background: #823E39" class="btn btn-sm btn-primary updatebtn" name="update" disabled>Update</button>
                        <button type="button" class="btn btn-default closepayment" data-dismiss="modal" aria-hidden="true">Close</button>
                  </div>  
              </form>
