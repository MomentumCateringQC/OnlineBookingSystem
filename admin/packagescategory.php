    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:100px">
              ...
              <form class="form-horizontal" method="post" action="packagescategory_update.php" enctype='multipart/form-data'>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post" action="packagescategory_delete.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="packagescategory_save.php" enctype='multipart/form-data'>
