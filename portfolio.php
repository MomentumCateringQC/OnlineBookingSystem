    ...
    // $dir ="portfolio/"; 
      ...
      while ($row=mysqli_fetch_array($query)){
        $portfoliocategory_id = $row['portfoliocategory_id'];
              ...
              <?php
              $query2=mysqli_query($con,"SELECT * FROM portfolio WHERE portfoliocategory_id = '$portfoliocategory_id'")or die(mysqli_error($con));
      while ($row2=mysqli_fetch_array($query2)){
              ?>

              <img  style=" width: 600px;height: 500px; margin: 16px; padding: 2px; position: center;" src="portfolio/<?php echo $row2['image'];?>">
